...
// cg2022QB3DTransDoc.cpp : Ccg2022QB3DTransDoc 类的实现
//
...
IMPLEMENT_DYNCREATE(Ccg2022QB3DTransDoc, CDocument)

BEGIN_MESSAGE_MAP(Ccg2022QB3DTransDoc, CDocument)
END_MESSAGE_MAP()


// Ccg2022QB3DTransDoc 构造/析构

Ccg2022QB3DTransDoc::Ccg2022QB3DTransDoc()
{
	// TODO: 在此添加一次性构造代码
...
BOOL Ccg2022QB3DTransDoc::OnNewDocument()
{
...
// Ccg2022QB3DTransDoc 序列化

void Ccg2022QB3DTransDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
		// TODO: 在此添加存储代码
...
// 缩略图的支持
void Ccg2022QB3DTransDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void Ccg2022QB3DTransDoc::InitializeSearchContent()
{
...
void Ccg2022QB3DTransDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
...
// Ccg2022QB3DTransDoc 诊断

#ifdef _DEBUG
void Ccg2022QB3DTransDoc::AssertValid() const
{
	CDocument::AssertValid();
}

void Ccg2022QB3DTransDoc::Dump(CDumpContext& dc) const
{
	CDocument::Dump(dc);
}
#endif //_DEBUG
...
// Ccg2022QB3DTransDoc 命令
void Ccg2022QB3DTransDoc::pCreateBallWithQuard()
{
	int i, j, polyCount;
...
void Ccg2022QB3DTransDoc::pCreateCube()
...
void Ccg2022QB3DTransDoc::pCreateClipBox()
{
	float u;
